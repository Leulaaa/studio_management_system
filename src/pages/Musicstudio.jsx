...
import photographyStudioImg from "../assets/Rectangle 31.png";
...
export default function Musicstudio() {
  ...
  const equipments = [
    "Professional microphones (condenser & dynamic).",
  ...
  return (
    <div className="">
      ...
      <button
        onClick={() => navigate("/booking/Music Studio")}
