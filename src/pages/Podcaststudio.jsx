...
import img1 from "../assets/Rectangle 2112 (3).png";
import img2 from "../assets/Rectangle 2113 (3).png";
import img3 from "../assets/Rectangle 2114 (2).png";
import img4 from "../assets/Rectangle 2115 (2).png";
...
import podcastImg from "../assets/Rectangle 31.png";
import photographyStudioImg from "../assets/Rectangle 2112 (2).png";

const podcastImages = [img1, img2, img3, img4];
const otherStudios = [
  { name: "Art Studio", image: musicImg, path: "/artstudio" },
  { name: "Photography Studio", image: podcastImg, path: "/photographystudio" },
...
export default function Podcaststudio() {
  ...
  const equipments = [
    ...
    "Mixing consoles and live audio monitoring.",
    "Perfect for interviews, podcasts, and voiceovers.",
    "Optional recording engineer support available.",
  ];
  ...
  const renderList = () => {
    if (activeTab === "equipments") return equipments;
    if (activeTab === "staffs") return staffs;
  };

  return (
    <div className="">
      <section className="max-w-6xl mx-auto p-6">
        <h1 className="text-3xl font-bold mb-6">Podcast Studio</h1>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-12 md:gap-40">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-gray-400 leading-relaxed max-w-xs text-center mx-auto">
              Sagittis enim nullam pulvinar tellus sitegestas. Vestibulum sed
